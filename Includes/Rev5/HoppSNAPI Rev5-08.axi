PROGRAM_NAME='HoppSNAPI Rev5-08'
(***********************************************************)
...
VD_SRC_CATV			=	74	//Momentary: Coax Cable Source Select
...
integer ATC_SPEEDDIAL[]	=	{33,34,35,36,37,38,39,40}

ATC_ON_HOOK			=	41	//Feedback: on hook
ATC_OFF_HOOK		=	42	//Feedback: off hook
ATC_RINGING			=	43	//Feedback: telco line ringing

ATC_SPEEDDIALNUM1	=	44	//Feedback: Speed Dial Number
ATC_SPEEDDIALNUM2	=	45	//Feedback: Speed Dial Number
ATC_SPEEDDIALNUM3	=	46	//Feedback: Speed Dial Number
ATC_SPEEDDIALNUM4	=	47	//Feedback: Speed Dial Number
ATC_SPEEDDIALNUM5	=	48	//Feedback: Speed Dial Number
ATC_SPEEDDIALNUM6	=	49	//Feedback: Speed Dial Number
ATC_SPEEDDIALNUM7	=	50	//Feedback: Speed Dial Number
ATC_SPEEDDIALNUM8	=	51	//Feedback: Speed Dial Number
integer ATC_SPEEDDIALNUM[]	=	{44,45,46,47,48,49,50,51}

ATC_SPEEDDIAL_QUERY	=	52  //Momentary: Query Speed Dials
