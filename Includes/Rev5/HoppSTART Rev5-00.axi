PROGRAM_NAME='HoppSTART Rev5-00'
(***********************************************************)
...
non_volatile	long		lMixQueryTimes[]={150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150,150}

define_variable //IP Varibales

non_volatile	long		lReconnectTime[]={30000}
volatile		integer		nWatchIPStrings
...
data_event[dvIPClient]
{
	...
	string:
	{
		if(nWatchIPStrings) send_string 0,"'IP ',itoa(get_last(dvIPClient)),': ',data.text"
	}
}
#END_IF
...
{
	if(vol[timeline.sequence].chan) 
	{
		pulse[vdvMXR[timeline.sequence],MIX_QUERY]
		//send_string 0,"'pulse vdvMXR[',itoa(timeline.sequence),',MIX_QUERY]'"
	}
}
