...
VD_SRC_VID 	   		=	13  //Momentary: Composite Video source select
VD_SRC_VID2			=	14	//Momentary: Composite Video 2 source select
VD_SRC_SVID			=	15  //Momentary: S-Video source select
VD_SRC_CMPNT		=	16  //Momentary: Component Video source select
...
VD_SRC_VID_FB	    =	279	//Feedback: video input
VD_SRC_VID2_FB		=	280	//Feedback: video 2 input
VD_SRC_SVID_FB		=	281	//Feedback: svideo input
VD_SRC_CMPNT_FB		=	282	//Feedback: component input 
