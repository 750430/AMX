...
button_event[dvTP_GUIDE,GUIDE_SHOW_ME]
{
	push:
	{
		send_command button.input.device,"'@PPN-',guideMain[nActiveGuidePage[nActiveTP]].sourcepopup,';Main Page'"
		send_command button.input.device,"'@PPN-',guideMain[nActiveGuidePage[nActiveTP]].headerpopup,';Main Page'"		
		...
		send_command button.input.device,"'@PPN-',guideMain[nActiveGuidePage[nActiveTP]].guidepopup,';Main Page'"
