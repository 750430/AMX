...
button_event[dvTP_LIGHT[1],LIGHTS_PRESETS]
{
	hold[15]:
	{
		...
		send_command button.input.device,"'@AKB-',cLight1PresetNames[nSetLight1PresetName],';Input Preset Name;;AKB-;1'" //Pop up the keypad so the user can input a speed dial number
	}
}
