...
button_event[dvTP_LIGHT[2],LIGHTS_PRESETS]
{
	hold[15]:
	{
		...
		send_command button.input.device,"'@AKB-',cLight2PresetNames[nSetLight2PresetName],';Input Preset Name'" //Pop up the keypad so the user can input a speed dial number
	}
}
