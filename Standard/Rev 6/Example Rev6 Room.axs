...
btnGuideSeeIt				=	34
btnGuideBack				=	35
btnGuideSeeItNext			=	36
btnGuidePageNum				=	37

integer btnVTCContentSelect[]	=	{41,42,43,44}
integer btnVTCCamSelect[]		=	{51,52,53}

integer btnGuideSteps[]		=	{61,62,63,64,65,66,67,68,69,70}
...
define_function tp_fb()
{
	...
	//Guide Feedback
	for(y=1;y<=NumTPs;y++) for(x=1;x<=length_array(btnGuideSteps);x++) [dvTP[y],btnGuideSteps[x]]=nActiveGuidePage[y]=x
}
...
ip[ipSwitcher].IPAddress 			=	'172.22.8.43'
ip[ipSwitcher].port					=	23
...
guideMain[1].paneCenter		=	'[help]Startup'

guideMain[2].popup[1]			=	'[help]Header'

guideMain[3].popup[1]			=	'[help]Sources 1'
guideMain[3].popup[2]			=	'[help]Sources 2'
guideMain[3].paneRight		=	'[paneRight]Destinations'
guideMain[3].paneCenter		=	'[source]PC'
guideMain[3].nActiveSource	=	srcPC1

guideMain[4].popup[1]			=	'[help]Destinations'
guideMain[4].paneRight		=	'[paneRight]Destinations'
guideMain[4].paneCenter		=	'[source]PC'
guideMain[4].nActiveSource	=	srcPC1

guideMain[5].popup[1]			=	'[help]Audio Conferencing'
guideMain[5].paneCenter		=	'[audioConf1]Keypad'
guideMain[5].nActiveSource	=	srcATC1

guideMain[6].popup[1]			=	'[help]Video Conferencing'
guideMain[6].paneLeft		=	'[paneLeft]Video Conf'
guideMain[6].paneCenter		=	'[videoConf]Cisco Menus'
guideMain[6].paneRight		=	'[paneRight]Destinations'
guideMain[6].nActiveSource	=	srcVTC
guideMain[6].nActiveSubMenu	=	1

guideMain[7].popup[1]			=	'[help]Video Conferencing Content'
guideMain[7].paneLeft		=	'[paneLeft]Video Conf'
guideMain[7].paneCenter		=	'[videoConf]Content'
guideMain[7].paneRight		=	'[paneRight]Destinations'
guideMain[7].nActiveSource	=	srcVTC
guideMain[7].nActiveSubMenu	=	3

guideMain[8].popup[1]			=	'[help]Volume'
guideMain[8].paneCenter		=	'[audio]Volume'
guideMain[8].nActiveMenu	=	mnuAudio

guideMain[9].popup[1]			=	'[help]Advanced'
guideMain[9].paneLeft		=	'[paneLeft]Advanced'
guideMain[9].paneCenter		=	'[roomSettings]Displays'
guideMain[9].nActiveMenu	=	mnuAdvanced
guideMain[9].nActiveSubMenu	=	1


guideMain[10].popup[1]			=	'[help]Shutting Down'

for(x=1;x<=guidePages;x++) guideMain[x].guidepopup		=	"'[guide]',itoa(x)"
...
//guideMain[1].page			=	'Title Page'
//guideMain[2].page			=	'Main Page'
//guideMain[3].page			=	'Main Page'
//guideMain[4].page			=	'Main Page'
//guideMain[5].page			=	'Main Page'
//guideMain[6].page			=	'Main Page'
//
//for(x=1;x<=8;x++) guideMain[2].dopushdevarray[x]	=	dvTP[x]
//guideMain[2].dopushchannel	=	btnStart
//
//for(x=1;x<=8;x++) guideMain[3].dopushdevarray[x]	=	dvTP_SRC[x]
//guideMain[3].dopushchannel	=	btnSources[srcPC1]
//
//for(x=1;x<=8;x++) guideMain[5].dopushdevarray[x]	=	dvTP_MENU[x]
//guideMain[5].dopushchannel	=	btnMenus[mnuAdvanced]
//
//for(x=1;x<=guidePages;x++) guideMain[x].guidepopup		=	"'[guide]',itoa(x)"
...
#INCLUDE 'Example Room GuideConfig'
#INCLUDE 'HoppGUIDE Rev6-00'
(***********************************************************)
(*                  MODULES GO BELOW                       *)
(***********************************************************)
define_module 'IR Devices Rev6-00' ir1(vdvTP_IR,dvIR)
//define_module 'Fake Projector Rev6-00' disp1(dvTP_DISP[1],vdvDISP1,vdvDISP1_FB,dvProj1,dstMain[1].screenup,dstMain[1].screendown,dstMain[1].liftup,dstMain[1].liftdown)
//define_module 'Fake Projector Rev6-00' disp2(dvTP_DISP[2],vdvDISP2,vdvDISP2_FB,dvProj2,dstMain[2].screenup,dstMain[2].screendown,dstMain[2].liftup,dstMain[2].liftdown)
...
button_event[dvTP,btnShutDownConfirm]
{
	...
	hold[30]:
	{
		switch(button.input.channel)
		{
			case btnShutDown: 
			{
				...
				send_command button.input.device,"'@PPN-[tech]Main;Tech Page'"
			}
		}
	}	
	release:
	{
		...
		switch(button.input.channel)
		{
			case btnShutDown: 
			{
				if(!nEnterTechMode)	send_command button.input.device,"'@PPN-[popup]Power;Main Page'"
			}
