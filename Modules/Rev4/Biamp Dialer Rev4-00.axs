MODULE_NAME='Biamp Dialer Rev4-00'(DEV vdvTP, DEV vdvATC, DEV dvATC, CHAR nAddr, INTEGER nInstID)
(***********************************************************)
...
volatile		char		cATCAddr	=	'1'	
	...
	define_module 'Biamp Dialer Rev4-00' ATC1(vdvTP_ATC1,vdvATC1,dvBiamp,cATCAddr,nInstID) 
*)
(***********************************************************)
