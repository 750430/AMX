MODULE_NAME='Epson Powerlite Rev4-00'(dev dvTP, dev vdvProj, dev dvProj)
(***********************************************************)
(* System Type : NetLinx                                   *)
(***********************************************************)
...
*)
//SET BAUD 9600,N,8,1
//define_module 'Epson Powerlite Rev4-00' proj1(vdvTP_DISP1,vdvDISP1,dvProj)
...
([vdvProj,VD_PWR_ON_FB],[vdvProj,VD_WARMING_FB],[vdvProj,VD_PWR_OFF_FB])
