MODULE_NAME='Pioneer Plasma PDP-607CMX Rev4-00'(dev dvTP, dev vdvPlas, dev dvPlas)
(***********************************************************)
...
//define_module 'Pioneer Plasma PDP-607CMX Rev4-00' disp1(vdvTP_DISP1,vdvDISP1,dvPlasma)
//Set baud to 9600,N,8,1
#INCLUDE 'HoppSNAPI.axi'
(***********************************************************)
...
([vdvPlas,VD_SRC_RGB1_FB],[vdvPlas,VD_SRC_RGB2_FB],[vdvPlas,VD_SRC_VID_FB],[vdvPlas,VD_SRC_SVID_FB],[vdvPlas,VD_SRC_RGB3_FB])

([dvTP,VD_PWR_ON],[dvTP,VD_PWR_OFF])
([dvTP,VD_SRC_RGB1],[dvTP,VD_SRC_RGB2],[dvTP,VD_SRC_VID],[dvTP,VD_SRC_SVID],[dvTP,VD_SRC_RGB3])
...
cCmdStr[VD_SRC_VID]		= "$02,'**IN1',$03"		//vid
	...
	SWITCH(TIMELINE.SEQUENCE)
	{
		CASE 1:
		{
			SWITCH(nCmd)
			{
				...
				CASE VD_SRC_RGB3:
				{
					IF(![vdvPlas,VD_PWR_ON_FB]) SEND_STRING dvPlas,"cCmdStr[VD_PWR_ON]"
					ELSE SEND_STRING dvPlas,"cCmdStr[nCmd]"
				}
				CASE VD_PWR_TOG:
				{
