MODULE_NAME='Sharp LCD LC52E77U Rev4-02'(dev dvTP, dev vdvLCD, dev dvLCD)
(***********************************************************)
...
(*  
	...
	define_module 'Sharp LCD LC52E77U Rev4-02' lcd1(vdvTP_DISP1,vdvDISP1,dvLCD)
...
cCmdStr[VD_CHAN_UP]		=	"'CHUP    ',$0D"
cCmdStr[VD_CHAN_DOWN]	=	"'CHDW    ',$0D"
...
BUTTON_EVENT[dvTP,0]
{
	PUSH:
	{
		switch(button.input.channel)
		{
			...
			CASE VD_CHAN_DOWN:
			{
				SEND_STRING dvLCD,cCmdStr[button.input.channel]
			}
			CASE VD_CHAN_DIGIT_0:	 
			CASE VD_CHAN_DIGIT_1:	
			CASE VD_CHAN_DIGIT_2:	
			CASE VD_CHAN_DIGIT_3:	
			CASE VD_CHAN_DIGIT_4:	
			CASE VD_CHAN_DIGIT_5:	
			CASE VD_CHAN_DIGIT_6:	
			CASE VD_CHAN_DIGIT_7:	
			CASE VD_CHAN_DIGIT_8:	
			CASE VD_CHAN_DIGIT_9:	
			{
				cChan = "cChan,ITOA(button.input.channel-60)"
				SEND_COMMAND dvTP,"'^TXT-1,0,',cChan"
			}
			CASE VD_CHAN_ENTER:
			{
				switch(length_string(cChan))
				{
					case 1: send_string dvLCD,"'DCCH',cChan,'   ',$0D"
					case 2: send_string dvLCD,"'DCCH',cChan,'  ',$0D"
					case 3: send_string dvLCD,"'DCCH',cChan,' ',$0D"
					case 4: send_string dvLCD,"'DCCH',cChan,$0D"
				}        
				cChan=''
				SEND_COMMAND dvTP,"'^TXT-1,0,',cChan"
			}
