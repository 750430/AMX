MODULE_NAME='Sanyo PL-WF10 Rev4-00'(DEV vdvTP, DEV vdvProj, DEV dvProj)
(***********************************************************)
...
cCmdStr[VD_SRC_DVI1]		= "'C05',$0D"	//input1 DVI PC Digital
cCmdStr[VD_SRC_RGB1]  		= "'C06',$0D"	//input2 RGBHV
cCmdStr[VD_SRC_VID] 		= "'C07',$0D"	//input2 video
