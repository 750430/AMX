MODULE_NAME='Epson G5200WPN Rev4-00'(dev dvTP, dev vdvProj, dev dvProj)
(***********************************************************)
(* System Type : NetLinx                                   *)
(***********************************************************)
...
*)
//SET BAUD 9600,N,8,1
//define_module 'Epson G5200WPN Rev4-00' proj1(vdvTP_DISP1,vdvDISP1,dvProj)
...
([vdvProj,VD_PWR_ON_FB],[vdvProj,VD_WARMING_FB],[vdvProj,VD_PWR_OFF_FB],[vdvProj,VD_COOLING_FB])
...
([vdvProj,VD_SRC_VID1_FB],[vdvProj,VD_SRC_SVID_FB],[vdvProj,VD_SRC_CMPNT1_FB],[vdvProj,VD_SRC_RGB1_FB],
 [vdvProj,VD_SRC_AUX1_FB],[vdvProj,VD_SRC_AUX2_FB],[vdvProj,VD_SRC_AUX3_FB],[vdvProj,VD_SRC_VGA1_FB])
(***********************************************************)
	...
	SWITCH(nPollType)
	{
		CASE PollPwr:
		{
			SELECT
			{
				...
				ACTIVE(FIND_STRING(cCompStr,"'PWR=00'",1)):
				{
