MODULE_NAME='NEC Projector Rev4-00'(DEV vdvTP, DEV vdvProj, DEV dvProj)
(***********************************************************)
...
([vdvTP,VD_SRC_RGB1],[vdvTP,VD_SRC_VGA1],[vdvTP,VD_SRC_DVI1],[vdvTP,VD_SRC_VID1],[vdvTP,VD_SRC_SVID],[vdvTP,VD_SRC_CMPNT1],[vdvTP,VD_SRC_CMPNT2])
...
([vdvProj,VD_SRC_RGB1_FB],[vdvProj,VD_SRC_VGA1_FB],[vdvProj,VD_SRC_DVI1_FB],[vdvProj,VD_SRC_VID1_FB],[vdvProj,VD_SRC_SVID_FB],[vdvTP,VD_SRC_CMPNT1_FB],[vdvTP,VD_SRC_CMPNT2_FB])
	...
	SELECT
	{
		...
		ACTIVE(FIND_STRING(cCompStr,"$20,$C0,$01,$10,$80",1)):
		{
			...
			select
			{
				...
				active(mid_string(cCompStr,7,2)=cRespStr[VD_SRC_RGB2]):
				{
				...
				active(mid_string(cCompStr,7,2)=cRespStr[VD_SRC_CMPNT2]):
				{
...
cCmdStr[VD_SRC_RGB1]  		= "$02,$03,$00,$00,$02,$01,$01"
cCmdStr[VD_SRC_RGB2]  		= "$02,$03,$00,$00,$02,$01,$02"
...
cRespStr[VD_SRC_CMPNT1]		= "$02,$04"
cRespStr[VD_SRC_CMPNT2]		= "$03,$04"
