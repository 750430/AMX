MODULE_NAME='Biamp Dialer Rev4-01'(DEV vdvTP, DEV vdvATC, DEV dvATC, CHAR nAddr, INTEGER nInstID)
(***********************************************************)
...
(*
	...
	define_module 'Biamp Dialer Rev4-01' ATC1(vdvTP_ATC1,vdvATC1,dvBiamp,cATCAddr,nInstID) 
*)
(***********************************************************)
...
DEFINE_FUNCTION Key(CHAR nVal[1])
{
	...
	IF([vdvATC,ATC_OFF_HOOK_FB]) SEND_STRING dvATC,"cDialStr,nVal,$0A"
}
