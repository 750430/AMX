MODULE_NAME='Sanyo PLV-80L Rev4-01'(DEV vdvTP, DEV vdvProj, DEV dvProj)
(***********************************************************)
...
(*   
	...
	define_module 'Sanyo PLV-80L Rev4-01' proj1(vdvTP_DISP1,vdvDISP1,dvProj)
*)
...
([vdvProj,VD_SRC_RGB1_FB],[vdvProj,VD_SRC_RGB2_FB],[vdvProj,VD_SRC_RGB3_FB],[vdvProj,VD_SRC_VID1_FB],[vdvProj,VD_SRC_SVID_FB],[vdvProj,VD_SRC_CMPNT1_FB])
		...
		CASE 1:	//first time
		{
			SWITCH(nCmd)
			{
				...
				CASE VD_SRC_CMPNT1:
				{
					...
					else IF([vdvProj,VD_PWR_OFF_FB] || [vdvProj, VD_COOLING_FB])
					{
						nPwrVerify = 1
