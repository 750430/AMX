MODULE_NAME='Sanyo Pro XtraX Rev4-00'(DEV vdvTP, DEV vdvProj, DEV dvProj)
(***********************************************************)
(*  FILE_LAST_MODIFIED_ON: 09/16/2008  AT: 16:08:32        *)
(***********************************************************)
(***********************************************************)
(* System Type : NetLinx                                   *)
(***********************************************************)
...
(*   
	...
	define_module 'Sanyo Pro XtraX Rev4-00' proj1(vdvTP_DISP1,vdvDISP1,dvProj)
*)
...
([vdvTP,VD_SRC_RGB1],[vdvTP,VD_SRC_RGB2],[vdvTP,VD_SRC_RGB3],[vdvTP,VD_SRC_VID1],[vdvTP,VD_SRC_SVID])
...
([vdvProj,VD_SRC_RGB1_FB],[vdvProj,VD_SRC_RGB2_FB],[vdvProj,VD_SRC_RGB3_FB],[vdvProj,VD_SRC_VID1_FB],[vdvProj,VD_SRC_SVID_FB])
...
cCmdStr[VD_SRC_RGB1]  		= "'C05',$0D"	//input1
cCmdStr[VD_SRC_RGB2]		= "'C06',$0D"	//input2
cCmdStr[VD_SRC_VID1] 		= "'C07',$0D"	//input2 video
