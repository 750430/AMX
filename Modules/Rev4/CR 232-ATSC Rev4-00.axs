MODULE_NAME='CR 232-ATSC Rev4-00'(DEV vdvTP[], DEV vdvTuner, DEV dvTuner)
(***********************************************************)
...
(*
	...
	define_module 'CR 232-ATSC Rev4-00' dev1(dvTP_DEV[1],vdvDEV1,dvTuner)
...
([vdvTuner,TUNER_PWR_ON_FB],[vdvTuner,TUNER_PWR_OFF_FB])
...
DEFINE_FUNCTION Parse(CHAR cCompStr[100])
{
	...
	SELECT
	{
		ACTIVE(FIND_STRING(cCompStr,'<1TU',1)):
		{
			...
			ON[vdvTuner,TUNER_PWR_ON_FB]
			[vdvTP,TUNER_PWR_ON]=[vdvTuner,TUNER_PWR_ON_FB]
		}	
		ACTIVE(FIND_STRING(cCompStr,'<1TM',1)):
		{
			ON[vdvTuner,TUNER_PWR_OFF_FB]
			[vdvTP,TUNER_PWR_OFF]=[vdvTuner,TUNER_PWR_OFF_FB]
		}
