MODULE_NAME='Christie DHD-800 Rev5-00'(DEV vdvTP, DEV vdvProj, DEV dvProj)
(***********************************************************)
(*  FILE_LAST_MODIFIED_ON: 08/30/2012  AT: 15:02:15        *)
(***********************************************************)
(***********************************************************)
(* System Type : NetLinx                                   *)
(***********************************************************)
...
(*   
	...
	define_module 'Christie DHD-800 Rev5-00' proj1(vdvTP_DISP1,vdvDISP1,dvProj)
*)

#INCLUDE 'HoppSNAPI Rev5-07.axi'
...
([vdvTP,VD_SRC_HDMI1],[vdvTP,VD_SRC_DVI1],[vdvTP,VD_SRC_VGA1],[vdvTP,VD_SRC_RGB1],[vdvTP,VD_SRC_VID1],[vdvTP,VD_SRC_SVID],[vdvTP,VD_SRC_CMPNT1])

([dvProj,VD_PWR_ON],[dvProj,VD_WARMING],[dvProj,VD_COOLING],[dvProj,VD_PWR_OFF])
([dvProj,VD_MUTE_ON],[dvProj,VD_MUTE_OFF])
([dvProj,VD_SRC_HDMI1],[dvProj,VD_SRC_DVI1],[dvProj,VD_SRC_VGA1],[dvProj,VD_SRC_RGB1],[dvProj,VD_SRC_VID1],[dvProj,VD_SRC_SVID],[dvProj,VD_SRC_CMPNT1])
...
cCmdStr[VD_SRC_VGA1]		= "'CF SOURCE 1 ANALOG',$0D"   //input1 VGA
cCmdStr[VD_SRC_DVI1]		= "'CF SOURCE 1 DIGITAL',$0D"	//input1 DVI PC Digital
cCmdStr[VD_SRC_HDMI1]		= "'CF SOURCE 1 HDMI',$0D"	//input1 DVI (AV HDCP)
cCmdStr[VD_SRC_RGB1]  		= "'CF SOURCE 2 ANALOG',$0D"	//input2 RGBHV
cCmdStr[VD_SRC_CMPNT1]		= "'CF SOURCE 2 YPBPR',$0D"	//input2 Y/Pb/Pr
cCmdStr[VD_SRC_VID1] 		= "'CF SOURCE 2 VIDEO',$0D"	//input2 video
cCmdStr[VD_SRC_SVID]		= "'CF SOURCE 2 S-VIDEO',$0D"	//input3 svideo
