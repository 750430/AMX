MODULE_NAME='Hitachi CPX-1200 Rev5-00'(DEV dvTP, DEV vdvProj, DEV dvProj)
(***********************************************************)
...
(*   
	...
	define_module 'Hitachi CPX-1200 Rev5-00' proj1(vdvTP_DISP1,vdvDISP1,dvProj)
*)
...
([dvTP,VD_SRC_RGB1],[dvTP,VD_SRC_VGA1],[dvTP,VD_SRC_VID1],[dvTP,VD_SRC_SVID],[dvTP,VD_SRC_CMPNT1])

([dvProj,VD_PWR_ON],[dvProj,VD_WARMING],[dvProj,VD_COOLING],[dvProj,VD_PWR_OFF])
([dvProj,VD_SRC_RGB1],[dvProj,VD_SRC_VGA1],[dvProj,VD_SRC_VID1],[dvProj,VD_SRC_SVID],[dvProj,VD_SRC_CMPNT1])
	...
	SWITCH(nPollType)
	{
		CASE PollPower:
		{
			SELECT
			{
				...
				ACTIVE(FIND_STRING(cCompStr,cRespStr[VD_PWR_OFF],1) and ![dvProj,VD_WARMING]):
				{	
