MODULE_NAME='Biamp Dialer Rev5-01'(DEV vdvTP, DEV vdvATC, DEV dvATC, CHAR cAddr, INTEGER nInstID)
(***********************************************************)
...
define_module 'Biamp Dialer Rev5-01' atc1(vdvTP_ATC1,vdvATC1,dvBiamp,cAddr,nInstID) 
*)
(***********************************************************)
