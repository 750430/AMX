MODULE_NAME='Biamp Vol Control Rev5-04'(DEV vdvTP[], DEV vdvMixer[], DEV dvMixer)
(***********************************************************)
...
Rev 04 - Only parsing strings that start with #.  This means we're only parsing 
things we've specifically asked for and not parsing echoes.  This could be a bad decision, 
keep an eye out for funkiness.
...
SET BAUD 38400,N,8,1 485 DISABLE
	...
	define_module 'Biamp Vol Control Rev5-04' mxr1(vdvTP_VOL,vdvMXR,dvBiamp) 
...
DEFINE_FUNCTION Parse(CHAR cCompStr[100])
{
	...
	if(left_string(cCompStr,1)='#')  //Only parse things with a #, that means they're actually responses and not echoes
	{
