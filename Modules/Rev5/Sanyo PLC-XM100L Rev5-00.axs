MODULE_NAME='Sanyo PLC-XM100L Rev5-00'(DEV vdvTP, DEV vdvProj, DEV dvProj)
(***********************************************************)
...
(*   
	...
	define_module 'Sanyo PLC-XM100L Rev5-00' proj1(vdvTP_DISP1,vdvDISP1,dvProj)
*)
...
([vdvTP,VD_SRC_RGB1],[vdvTP,VD_SRC_RGB2],[vdvTP,VD_SRC_RGB3],[vdvTP,VD_SRC_VID1],[vdvTP,VD_SRC_SVID],[vdvTP,VD_SRC_CMPNT1])
	...
	SWITCH(nPollType)
	{
		CASE PollPower:
		{
			SELECT
			{
				...
				ACTIVE(FIND_STRING(cCompStr,cRespStr[VD_PWR_OFF],1) or (FIND_STRING(cResp,"'04',$0D",1))):
				{	
				...
				ACTIVE(FIND_STRING(cCompStr,cRespStr[VD_COOLING],1) or(FIND_STRING(cResp,"'24',$0D",1))):	//Cooling Down
				{
					ON[dvProj,VD_COOLING]
					ON[vdvTP,VD_PWR_OFF]
					IF(ncmd = VD_PWR_OFF) CmdExecuted()
				}
				ACTIVE (FIND_STRING(cResp,"'10',$0D",1) || 
							 FIND_STRING(cResp,"'28',$0D",1) || FIND_STRING(cResp,"'21',$0D",1) ||
							 FIND_STRING(cResp,"'88',$0D",1) ||
