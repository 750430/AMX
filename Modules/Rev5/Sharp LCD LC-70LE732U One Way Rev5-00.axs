MODULE_NAME='Sharp LCD LC-70LE732U One Way Rev5-00'(dev dvTP, dev vdvLCD, dev dvLCD)
(***********************************************************)
(*  FILE_LAST_MODIFIED_ON: 05/25/2012  AT: 05:25:29        *)
(***********************************************************)
(***********************************************************)
(* System Type : NetLinx                                   *)
(***********************************************************)
...
(*  
	...
	define_module 'Sharp LCD LC-70LE732U Rev5-00' LCD1(vdvTP_DISP1,vdvDISP1,dvLCD1)
...
DEFINE_FUNCTION Parse(CHAR cCompStr[100])
{
	...
	SWITCH(nPollType)
	{
		...
		CASE PollSrc:
		{
			SELECT
			{
				ACTIVE(FIND_STRING(cCompStr,"'1'",1)):  //HDMI 1
				{
				...
				ACTIVE(FIND_STRING(cCompStr,"'TV'",1)):
				{
					ON[dvLCD,VD_SRC_CATV]
					ON[dvTP,VD_SRC_CATV]
					IF(nCmd=VD_SRC_CATV) CmdExecuted()	
				}	
			}
		}
		CASE PollMute: 
...
cCmdStr[VD_SRC_CATV]	=	"'ITVD0   ',$0D"	//cable TV tuner input (RF IN)
