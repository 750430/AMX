MODULE_NAME='Sanyo PLC-XF42 Rev5-00'(DEV vdvTP, DEV vdvProj, DEV dvProj)
(***********************************************************)
...
(*   
	...
	define_module 'Sanyo PLV-80L Rev5-00' proj1(vdvTP_DISP1,vdvDISP1,dvProj)
*)
...
cCmdStr[VD_SRC_VGA1]		= "'C08',$0D"   //input1 VGA
...
cCmdStr[VD_SRC_VID2] 		= "'CF INPUT3 VIDEO',$0D"	//input3 video
