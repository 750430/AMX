MODULE_NAME='Panasonic PT-EW640 Rev5-00'(DEV dvTP, DEV vdvProj, DEV dvProj)
(***********************************************************)
...
(*   
	...
	define_module 'Panasonic PT-EW640 Rev5-00' proj1(vdvTP_DISP1,vdvDisp1,dvProj)
*)
...
([dvTP,VD_SRC_RGB1],[dvTP,VD_SRC_VID1],[dvTP,VD_SRC_VGA1],[dvTP,VD_SRC_SVID],[dvTP,VD_SRC_AUX1])

([dvProj,VD_PWR_ON],[dvProj,VD_WARMING],[dvProj,VD_COOLING],[dvProj,VD_PWR_OFF])
([dvProj,VD_MUTE_ON],[dvProj,VD_MUTE_OFF])
([dvProj,VD_SRC_RGB1],[dvProj,VD_SRC_VID1],[dvProj,VD_SRC_VGA1],[dvProj,VD_SRC_SVID],[dvProj,VD_SRC_AUX1])
...
cCmdStr[VD_SRC_AUX1] 		= "$02,'ADZZ;IIS:DL1',$03"	
cCmdStr[VD_MUTE_ON] 		= "$02,'ADZZ;OSH:1',$03"	
cCmdStr[VD_MUTE_OFF] 		= "$02,'ADZZ;OSH:0',$03"	
