MODULE_NAME='AMX DVX2100 Volume Control Rev5-00'(DEV vdvTP[], DEV vdvAMX[], DEV dvAMX)
(***********************************************************)
...
(*
	...
	define_module 'AMX DVX2100 Volume Control Rev5-00' mxr1(vdvTP_VOL,vdvMXR,dvAMXVol) 
...
data_event[vdvTP]
{
	online:
	{
		wait 100 
		{
			send_command dvAMX,"'?XPOINT-',itoa(nInput),',2'"
