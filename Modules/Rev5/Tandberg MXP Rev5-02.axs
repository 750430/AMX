MODULE_NAME='Tandberg MXP Rev5-02'(DEV vdvTP, DEV vdvVTC, DEV dvVTC)
(***********************************************************)
...
//define_module 'Tandberg MXP Rev5-02' vtc1(vdvTP_VTC1,vdvVTC1,dvVTC)
//Set Baud 9600,N,8,1
(***********************************************************)
...
{
	SEND_STRING dvVTC,"'key ',cKey,$0D,$0A"
...
{
	send_string dvVTC, "'key cancel',$0D,$0A"
...
CHANNEL_EVENT [vdvVTC, 0]
{
	ON:
	{
		...
		SWITCH (nChnl)
		{
			...
			CASE VTC_SWITCH_8:
			{
				send_string dvVTC, "'xConfiguration Switch Source: ',itoa(nChnl-VTC_SWITCH_1+1),$0D"
			}			
			CASE VTC_CAM_PRESET1:
			CASE VTC_CAM_PRESET2:
			CASE VTC_CAM_PRESET3:
