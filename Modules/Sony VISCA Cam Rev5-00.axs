MODULE_NAME='Sony VISCA Cam Rev5-00' (DEV vdvTP[], DEV vdvCAM[])
(***********************************************************)
...
//define_module 'Sony VISCA Cam Rev5-00' CAM1(vdvTP_CAM,vdvCAM)
  ...
  PUSH:
  {
	...
	HOLD[30]:
	{
		...
		IF(nCTRL >= CAM_PRESET1 && nCTRL <= CAM_PRESET6)
		{
			...
			SEND_COMMAND vdvTP[nCAM],"'AABEEP'"
		}
	}
  RELEASE:
  {
...
CHANNEL_EVENT[vdvCAM, 0]
{
  ON:
  {
		...
		SWITCH(nPTZPre)
		{
			...
			CASE CAM_PRESET6:
			{
				SEND_STRING SONY_CAM[nCAM].dvCAM, "addr,$01,$04,$3F,$01,cPTZPre[nPTZPre],$FF"
			}
		}
  }
  OFF:
