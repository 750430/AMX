MODULE_NAME='Biamp Vol Control Rev5-01'(DEV vdvTP[], DEV vdvMixer[], DEV dvMixer)
(***********************************************************)
(*  FILE_LAST_MODIFIED_ON: 10/06/2011  AT: 18:21:13        *)
(***********************************************************)
(***********************************************************)
(* System Type : NetLinx                                   *)
(***********************************************************)
...
SET BAUD 38400,N,8,1 485 DISABLE
	...
	define_module 'Biamp Vol Control Rev5-01' mxr1(vdvTP_VOL,vdvMXR,dvBiamp) 

*)
(***********************************************************)
#INCLUDE 'HoppSNAPI Rev5-03.axi'
#INCLUDE 'HoppSTRUCT Rev5-01.axi'
(***********************************************************)
