MODULE_NAME='NEC LCD E553 Rev5-00'(dev dvTP, dev vdvLCD, dev dvLCD)
(***********************************************************)
...
(*  
	...
	define_module 'NEC LCD E553 Rev5-00' lcd1(vdvTP_DISP1,vdvDISP1,dvLCD)
	...
	SWITCH(nPollType)
	{
		CASE PollPwr:
		{
			SELECT
			{
				...
				ACTIVE(FIND_STRING(cCompStr,"'C203D60004',$03",1) || FIND_STRING(cCompStr,"'000003D60004',$03",1)):
				{
					ON[dvLCD,VD_PWR_OFF]
					ON[dvTP,VD_PWR_OFF]
