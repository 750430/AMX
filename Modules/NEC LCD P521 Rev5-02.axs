MODULE_NAME='NEC LCD P521 Rev5-02'(dev dvTP, dev vdvLCD, dev dvLCD)
(***********************************************************)
...
(*  
	...
	define_module 'NEC LCD P521 Rev5-02' lcd1(vdvTP_DISP1,vdvDISP1,dvLCD)
...
volatile		integer		nInput[]={VD_SRC_DVI1,VD_SRC_DVI2,VD_SRC_DVI3,VD_SRC_VGA1,VD_SRC_CMPNT1,VD_SRC_CMPNT2,VD_SRC_RGB1,VD_SRC_VID1,VD_SRC_VID2,VD_SRC_SVID,VD_SRC_AUX1,VD_SRC_AUX2}
...
[dvTP,VD_SRC_RGB1],[dvTP,VD_SRC_VID1],[dvTP,VD_SRC_VID2],[dvTP,VD_SRC_SVID],[dvTP,VD_SRC_AUX1],[dvTP,VD_SRC_AUX2])
...
[dvLCD,VD_SRC_RGB1],[dvLCD,VD_SRC_VID1],[dvLCD,VD_SRC_VID2],[dvLCD,VD_SRC_SVID],[dvLCD,VD_SRC_AUX1],[dvLCD,VD_SRC_AUX2])
(***********************************************************)
...
define_function Parse(CHAR cCompStr[100])
{
	...
	SWITCH(nPollType)
	{
		CASE PollPwr:
		{
			SELECT
			{
				ACTIVE(FIND_STRING(cCompStr,"'C203D60001',$03,'v'",1)):
				{
					nActivePower=VD_WARMING
				}
				ACTIVE(FIND_STRING(cCompStr,"'D60000040001',$03,'t'",1)):
				{
				...
				ACTIVE(FIND_STRING(cCompStr,"'C203D60004',$03,'s'",1)):
				{
					nActivePower=VD_COOLING
				}
				ACTIVE(FIND_STRING(cCompStr,"'D60000040004',$03,'q'",1)):
				{
		...
		CASE PollSrc:
		{
			SELECT
			{
				...
				ACTIVE(FIND_STRING(cCompStr,"'060000011000D',$03",1)):
				{
...
cCmdStr[VD_SRC_AUX2]		= "$01,'0*0E0A',$02,'0060000D',$03"				//Input Option card

cCmdStr[VD_CHAN_UP]			=	"$01,'0*0E0A',$02,'008B0001',$03"
cCmdStr[VD_CHAN_DOWN]		=	"$01,'0*0E0A',$02,'008B0002',$03"
