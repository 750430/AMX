MODULE_NAME='Christie LW555 Rev5-00'(DEV vdvTP, DEV vdvProj, DEV dvProj)
(***********************************************************)
...
(*   
	...
	define_module 'Christie LW555 Rev5-00' proj1(vdvTP_DISP1,vdvDISP1,dvProj)
*)
...
cCmdStr[VD_SRC_VGA1]		= "'C05',$0D"   //input1 VGA
cCmdStr[VD_SRC_DVI1]		= "'CF SOURCE 1 DIGITAL',$0D"	//input1 DVI PC Digital
cCmdStr[VD_SRC_HDMI1]		= "'C05',$0D"	//input1 DVI (AV HDCP)
cCmdStr[VD_SRC_RGB1]  		= "'C06',$0D"	//input2 RGBHV
