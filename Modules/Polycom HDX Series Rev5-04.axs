module_name='Polycom HDX Series Rev5-04'(dev dvTP,dev vdvVTC,dev dvVTC,integer nContentInput)
(***********************************************************)
...
//SET BAUD 9600,N,8,1
//define_module 'Polycom HDX Series Rev5-04' vtc1(vdvTP_VTC1,vdvVTC1,dvVTC,nVTCContentInput)
...
define_function Parse(char cCompStr[100])
{
	...
	select
	{
		active(find_string(cCompStr,"'mute near on'",1)): on[nPrivacy]
		active(find_string(cCompStr,"'mute near off'",1)): off[nPrivacy]
		active(find_string(cCompStr,"'vcbutton stop'",1)
			or find_string(cCompStr,"'vcbutton play failed'",1)): off[nContent]
		active(find_string(cCompStr,"'vcbutton play'",1)): on[nContent]
		active(find_string(cCompStr,"'camera near 1'",1) or find_string(cCompStr,"'camera near source 1'",1)): nCamSource=VTC_NR_VID1
		active(find_string(cCompStr,"'camera near 2'",1) or find_string(cCompStr,"'camera near source 2'",1)): nCamSource=VTC_NR_VID2
...
[dvTP,VTC_PRIVACY_TOG]	= nPrivacy
[dvTP,VTC_PRIVACY_OFF]	= !nPrivacy
[dvTP,VTC_PRIVACY_ON]	= nPrivacy

[dvVTC,VTC_PRIVACY_OFF]	= !nPrivacy
[dvVTC,VTC_PRIVACY_ON]	= nPrivacy

for(x=VTC_NR_VID1;x<=VTC_NR_VID5;x++) [dvTP,x]=nCamSource=x
