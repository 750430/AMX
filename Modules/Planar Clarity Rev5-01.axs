MODULE_NAME='Planar Clarity Rev5-01'(dev dvTP, dev vdvWall, dev dvWall)
(***********************************************************)
...
//define_module 'Planar Clarity Rev5-01' proj1(vdvTP_DISP1,vdvDISP1,dvWall)
...
TIMELINE_EVENT[lTLCmd]
{
	SWITCH(TIMELINE.SEQUENCE)
	{
		CASE 1:	//first time
		{
			SWITCH(nCmd)
			{
				CASE VD_PRESET_1: send_string dvWall,"'OPA1slot.target=0',$0D"
				CASE VD_PRESET_2: send_string dvWall,"'OPA1slot.target=1',$0D"
				CASE VD_PRESET_3: send_string dvWall,"'OPA1slot.target=2',$0D"
				CASE VD_PRESET_4: send_string dvWall,"'OPA1slot.target=3',$0D"
				CASE VD_PRESET_5: send_string dvWall,"'OPA1slot.target=4',$0D"
				CASE VD_PRESET_6: send_string dvWall,"'OPA1slot.target=5',$0D"
				CASE VD_PRESET_7: send_string dvWall,"'OPA1slot.target=6',$0D"
				CASE VD_PRESET_8: send_string dvWall,"'OPA1slot.target=7',$0D"
				CASE VD_PRESET_9: send_string dvWall,"'OPA1slot.target=8',$0D"
				CASE VD_PRESET_10: send_string dvWall,"'OPA1slot.target=9',$0D"
			}		
			SWITCH(nCmd)
			{
				CASE VD_PWR_ON:
				...
				{             
					...
					send_string dvWall,"'OPA1slot.action (recall)',$0D"
					CmdExecuted()
				}
			}
		}
