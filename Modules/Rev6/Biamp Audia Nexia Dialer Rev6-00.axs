module_name='Biamp Audia Nexia Dialer Rev6-00'(dev dvTP[], dev vdvATC, dev vdvATC_FB, dev dvATC, char cAddr, integer nInstID)
(***********************************************************)
...
//define_module 'Biamp Audia Nexia Dialer Rev6-00' atc1(dvTP_ATC[1],vdvATC1,vdvATC1_FB,dvBiamp,cAddr,nInstID) 
...
non_volatile	long		lHookTime[]={5000,5000,5000,5000}
...
timeline_create(tlHookStatus,lHookTime,length_array(lHookTime),timeline_relative,timeline_repeat)
...
timeline_event[tlHookStatus]
{
	switch(timeline.sequence)
	{
		case 1: pulse[vdvATC,ATC_QUERY]
		default: if(nActiveCallStatus) pulse[vdvATC,ATC_QUERY]
	}
}
