MODULE_NAME='Lutron GEye All Zones Rev6-00'(dev dvTP[], dev vdvLights, dev vdvLightsFB, dev dvLights)
(***********************************************************)
(* System Type : NetLinx                                   *)
(***********************************************************)
(* REV HISTORY:                                            *)
...
BUTTON_EVENT[dvTP, btnScenes]//call scenes
{
	PUSH:
	{
		...
		SELECT
		{
			ACTIVE(nScene = 9):
			{
				SEND_STRING dvlights,"':A012345678',$0D" 
			}
			ACTIVE (nScene):  
			{	
				SEND_STRING dvlights,"':A',ITOA(nScene),'12345678',$0D"
			}
		}    
	}
	release:
