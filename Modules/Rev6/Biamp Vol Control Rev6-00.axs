module_name='Biamp Vol Control Rev6-00'(dev dvTP[], dev vdvMixer[], dev vdvMixer_FB[], dev dvMixer)
(***********************************************************)
...
SET BAUD 38400,N,8,1 485 DISABLE
	...
	define_module 'Biamp Vol Control Rev6-00' mxr1(vdvTP_VOL,vdvMixer,vdvMixer_FB,dvBiamp) 
