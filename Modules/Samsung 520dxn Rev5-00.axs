MODULE_NAME='Samsung 520dxn Rev5-00'(dev dvTP, dev vdvLCD, dev dvLCD)
(***********************************************************)
...
//define_module 'Samsung 520dxn Rev5-00' LCD1(vdvTP_DISP1,vdvDISP1,dvLCD)
...
CHANNEL_EVENT[vdvLCD,0]
{
	ON:
	{
		send_string 0,"'Samsung 520dxn receiving channel ',itoa(channel.channel)"
		SELECT
		{
			...
			ACTIVE(channel.channel=VD_POLL_BEGIN):
			{
				send_string 0,"'Samsung 520dxn creating lTLPoll'"
				TIMELINE_CREATE(lTLPoll,lPollArray,1,TIMELINE_RELATIVE,TIMELINE_REPEAT)
			}
		}
	}
