MODULE_NAME='Auto Shutdown Rev5-00'(dev dvTP,DEV dvSetupTP[], integer btnShutDown)
(***********************************************************)
(* System Type : NetLinx                                   *)
(***********************************************************)
(* REV HISTORY:  *)
...
define_module 'Auto Shutdown Rev5-00' sd1(dvTP[1],dvTP_DEV[1],nbtnShutDown)
*)
...
volatile		long		lShutDownWarningTimes[]={300000}
