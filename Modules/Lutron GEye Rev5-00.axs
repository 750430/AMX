MODULE_NAME='Lutron GEye Rev5-00'(DEV dvTP, DEV dvLights, INTEGER nAddr)
(***********************************************************)
(* System Type : NetLinx                                   *)
(***********************************************************)
(* REV HISTORY:                                            *)
...
//define_module 'Lutron GEye Rev5-00' LIGHTS1(vdvTP_LIGHT1,dvLights,nLightingAddr)
DEFINE_DEVICE
...
BUTTON_EVENT[dvTP, btnScenes]//call scenes
{
	PUSH:
  {
    ...
    SELECT
		...
		{
			SEND_STRING dvlights,"':A',ITOA(GET_LAST(btnScenes)),ITOA(nAddr),$0D"
		}
    }    
  }
}
