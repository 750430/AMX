MODULE_NAME='Sharp LCD PN-S655 Rev5-00'(dev dvTP, dev vdvLCD, dev dvLCD)
(***********************************************************)
...
(*  
	...
	define_module 'Sharp LCD PN-S655 Rev5-00' LCD1(vdvTP_DISP1,vdvDISP1,dvLCD1)
...
volatile		integer		nVidMute[]={VD_MUTE_ON,VD_MUTE_OFF}
		...
		SWITCH(TIMELINE.SEQUENCE)
		{
			CASE 1:	//first time
			{
				SWITCH(nCmd)
				{
					...
					CASE VD_PCADJ:
					{
						IF([dvLCD,VD_PWR_ON]) SEND_STRING dvLCD,cCmdStr[nCmd]
						CmdExecuted()
					}
				}
			}
